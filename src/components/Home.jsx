    ...
    <div name="home" className='w-full h-screen bg-[#0a192f]'>
      ...
      <div className='max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full'>
        ...
        <div className='flex flex-col sm:flex-row'>
          ...
          <a href='https://www.dropbox.com/scl/fi/ry5a2roeylvpne8txmij5/Karthick_Kumar_SM_Resume.pdf?rlkey=yricu1qd420mvs5ff185ynoo9&st=5xm98rid&dl=0' target="_blank" rel="noopener noreferrer" className='text-white group border-2 px-6 py-3 my-2 flex items-center hover:bg-blue-600 hover:border-blue-600 sm:ml-5'>
