        ...
        <div className='hidden lg:flex fixed  flex-col top-[35%] left-0'>
            <ul>
                ...
                <li className='w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-[#565f65]'>
                    <a href='https://www.dropbox.com/scl/fi/4vgb1ntzc55n53rhf9z0p/Karthick_Kumar_SM_Resume.pdf?rlkey=feovv4yjjsc32kpuerpqes4ov&dl=0' target="_blank" className='flex justify-between items-center w-full text-gray-300'>
